            ...
            <div className='contact-content'>
                ...
                <form onSubmit={handleSubmit(onSubmitContact)} className='contact-form'>
                    ...
                    <div>
                        ...
                        <textarea {...register('content')} type="content" className={classnames("width-250 mg-b-15", `${errors.content ? "border border-danger" : ""}`)} id="content" placeholder="abcxyz..."/>
                        <p className="text-danger">{errors.content?.message}</p>
                    </div>
                    <div style={{"textAlign": "center"}}>
                        <button className={classnames("width-250")} disabled={isSubmitting} type="submit">Gửi liên hệ</button>
                    </div>
                </form>
            </div>
        </div>
